...
if ((isset($_GET['uid'])) && ($_GET['uid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM %s WHERE attRef=%s and profileID=%s", $_SESSION['MM_DBTable'], 
...
mysql_select_db($database_connUKTIsms, $connUKTIsms);
$query_rsContacts = sprintf("SELECT * FROM %s WHERE profileID = %s",$_SESSION['MM_DBTable'], GetSQLValueString($colname_rsContacts, "int"));
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td align="center"><strong>Add/Delete </strong><br />
<input id="cb" type="button" onclick="check(this.form.attID)" value="Check all"/></td>
      ...
      <?php do { ?>
        <tr>
		  ...
		  <input id="attID" name="addToList[]" type="checkbox" id="addToList[]" value="<?php echo $row_rsContacts['attRef']; ?>" />
		  <?php } ?></td>
        ...
        <tr>
          <td colspan="5" align="right"><input id="cb2" type="button" onclick="check(this.form.attID)" value="Check all"/>&nbsp;&nbsp;<input name="sisAdd" type="hidden" id="sisAdd" value="true" />
            &nbsp;&nbsp;<input type="submit" name="addTo" value="Add to SMS List" />&nbsp;&nbsp;<input type="submit" name="deleteFrom" value="Delete checked contacts" /></td>
          </tr>
    </table>
	</form>
	<br/>
